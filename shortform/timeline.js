...
(function () {
  const SCENES = [
    { k: 'intro',   cue0: 66.0, base: 4.0, full: 4.0, short: 4.0 },   // 인트로 컷(CRT) — 표시는 맨 앞
    { k: 'hook',    cue0:  0.0, base: 4.0, full: 3.6, short: 2.7 },
    { k: 's6',      cue0: 70.0, base: 6.4, full: 6.4, short: 5.2 },   // 스크러버·칠러 만담(3D 캐릭터)
    { k: 'silane',  cue0:  6.4, base: 3.4, full: 3.6, short: 3.3 },   // S1 컷 길이
    { k: 'sf6',     cue0:  9.8, base: 3.4, full: 2.1, short: 0   },   // S3 ctx 1.8 + 스탬프 홀드 0.3
    { k: 'chill',   cue0: 13.2, base: 3.4, full: 3.9, short: 3.5 },   // S2 컷 길이
    { k: 'stop',    cue0: 16.6, base: 3.4, full: 2.2, short: 2.2 },   // S4 ctx 1.8 + 스탬프 홀드 0.4
    ...
    { k: 'map',     cue0: 34.4, base: 5.2, full: 3.6, short: 2.8 },
    { k: 'stairs',  cue0: 39.6, base: 4.2, full: 2.4, short: 1.8 },   // 꺾은선 화살표로 압축(v14)
    { k: 'future',  cue0: 43.8, base: 3.9, full: 4.3, short: 3.4 },   // 3D 컷 3.9 + 스탬프 홀드 0.4
