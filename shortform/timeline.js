...
(function () {
  const SCENES = [
    ...
    { k: 's6',      cue0: 70.0, base: 6.4, full: 6.2, short: 5.2 },   // 스크러버·칠러 만담(3D 캐릭터)
    ...
    { k: 'reveal',  cue0: 20.0, base: 4.8, full: 4.2, short: 3.6 },
    { k: 'pivot',   cue0: 24.8, base: 2.0, full: 1.8, short: 1.2 },
    { k: 'found',   cue0: 26.8, base: 4.0, full: 3.6, short: 2.2 },
    { k: 'kosdaq',  cue0: 30.8, base: 3.6, full: 2.9, short: 0   },   // 2박자: 상장 → 2026 시총 1조
    { k: 'map',     cue0: 34.4, base: 5.2, full: 3.3, short: 2.8 },
    { k: 'stairs',  cue0: 39.6, base: 4.2, full: 2.4, short: 1.7 },   // 꺾은선 화살표로 압축(v14)
    { k: 'future',  cue0: 43.8, base: 3.9, full: 4.3, short: 3.4 },   // 3D 컷 3.9 + 스탬프 홀드 0.4
    { k: 'close',   cue0: 52.2, base: 4.6, full: 4.3, short: 3.7 },
