...
(function () {
  ...
  const SCENES = [
    ...
    { k: 'hook',    cue0:  0.0, base: 4.0, full: 3.4, short: 2.5, fullA: 3.6, fullB: 3.8 },
    { k: 's6',      cue0: 70.0, base: 6.4, full: 6.4, short: 5.0, fullB: 0 },   // 스크러버·칠러 만담(3D 캐릭터)
    ...
    { k: 'reveal',  cue0: 20.0, base: 4.8, full: 4.4, short: 3.4, fullA: 4.9, fullB: 5.4 },
    { k: 'pivot',   cue0: 24.8, base: 2.0, full: 1.8, short: 1.2 },
    { k: 'found',   cue0: 26.8, base: 4.0, full: 3.8, short: 2.0, fullA: 4.1, fullB: 4.6 },
    { k: 'map',     cue0: 34.4, base: 5.2, full: 3.5, short: 2.6, fullA: 4.0, fullB: 4.4 },   // 표시 순서를 kosdaq «앞»으로 (연대 일원화 · v19)
    { k: 'kosdaq',  cue0: 30.8, base: 3.6, full: 3.8, short: 3.0, fullA: 4.7, fullB: 5.0 },   // 성장 3박: 상장 → 수출 1억불(2021) → 시총 1조(2026)
    { k: 'stairs',  cue0: 39.6, base: 4.2, full: 0,   short: 0   },   // v19: 별도 씬에서 빼고 성장 곡선의 이정표로 접었다
    { k: 'future',  cue0: 43.8, base: 3.9, full: 4.7, short: 3.2, fullB: 5.5 },   // 3D 컷 3.9 + 홀드 — 성장 곡선이 2026에 닿은 뒤 받는 장면
    { k: 'close',   cue0: 52.2, base: 4.6, full: 4.6, short: 3.6, fullB: 5.3 },
    { k: 'end',     cue0: 56.8, base: 6.3, full: 6.7, short: 5.9, fullB: 7.3 },   // 로고 리빌: base 보다 길다(느려질 뿐 안 깨진다)
