...
(async () => {
  ...
  span(31.6, 32.4, 'riser');
  at(32.55, 'bell', { n: 96, g: 0.15, d: 0.7 }); at(32.63, 'bell', { n: 100, g: 0.13, d: 0.9 });   // 1박: 상장
  // 2박: 2026 시총 1조 — 금색 선이 치솟는 동안 올라가는 블립, 착지에서 심벌+큰 벨 (v18)
  [700, 880, 1050].forEach((f, i) => at(32.75 + i * 0.2, 'blip', { f, g: 0.06 }));
  span(32.8, 33.5, 'riser');
  at(33.55, 'cymbal'); at(33.55, 'bell', { n: 91, g: 0.16, d: 1.2 }); at(33.63, 'bell', { n: 96, g: 0.13, d: 1.5 });
