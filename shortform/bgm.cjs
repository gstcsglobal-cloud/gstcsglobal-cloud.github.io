...
(async () => {
  ...
  // 로고 리빌 — 그림(빛줄기→교차→로고)과 «같은 시각»에 붙는다. 그림만 바꾸고 여기를 두면 소리가 먼저 끝난다
  span(58.42, 59.06, 'riser');
  at(58.55, 'whoosh'); at(58.64, 'whoosh');                                              // 빛줄기 두 줄
  at(59.02, 'thud'); at(59.04, 'bwomp');                                                 // 교차 지점의 섬광
  [88, 91, 96].forEach((n, i) => at(59.62 + i * 0.07, 'bell', { n, g: 0.12, d: 1.5 }));  // 로고가 맺힌다
  at(60.22, 'bell', { n: 84, g: 0.11, d: 1.3 });                                         // Build Up GST
  [79, 83, 88].forEach((n, i) => at(60.86 + i * 0.18, 'bell', { n, g: 0.10, d: 0.9 }));  // GST · EST · ROBOCARE
  at(61.55, 'bell', { n: 91, g: 0.09, d: 1.2 });
